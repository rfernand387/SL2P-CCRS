...
%                              Input_PROSPECT.alpha(1));
  ...
  % drop last 100 wavelengths to comply with SL2P
    GreenVegetation.lambda = GreenVegetation.lambda(1:2001,:);
    GreenVegetation.Reflectance = GreenVegetation.Reflectance(1:2001,:);
    GreenVegetation.Transmittance = GreenVegetation.Transmittance(1:2001,:);
...
%                                         Input_PROSPECT.alpha(2))
         BrownVegetation = prospect_DB(Input_PROSPECT.N(2), ...
                                        ...
                                        Input_PROSPECT.LMA(2));
          % drop last 100 wavelengths to comply with SL2P
        BrownVegetation.lambda = BrownVegetation.lambda(1:2001,:);
        BrownVegetation.Reflectance = BrownVegetation.Reflectance(1:2001,:);
        BrownVegetation.Transmittance = BrownVegetation.Transmittance(1:2001,:);
